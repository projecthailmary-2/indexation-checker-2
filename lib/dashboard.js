...
// Sunday of the week containing d. Weeks run Sun–Sat to match the runner's
// week-gate and the daily summary — and, crucially, to keep a whole pass in ONE
// week: the Monday-Manila pass starts at Sun 22:00 UTC, so its first rows carry
// Sunday's (UTC) date; a Monday-start week would split them into the prior week.
