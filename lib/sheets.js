...
// A run row is "clean" only if all four measured values are real numbers.
function isClean(r) {
  return isNum(r.serpCount) && isNum(r.wpCount) && isNum(r.totalSequoia) && isNum(r.indexedSequoia);
}
